  ...
  return (
    <div className="min-h-screen bg-[#161616] relative overflow-hidden font-pixel">
      ...
      <div className="relative z-10 text-white text-xl flex flex-col mt-5 mx-4 lg:mx-64">
        <h1 className="mx-auto text-[4rem] md:text-[4rem] lg:text-[6rem] font-pixel my-14 lg:my-20">
        ...
        <div className="flex flex-row gap-5 justify-center">
          <div
            className="h-64 w-64 bg-slate-400 relative pixel-border text-center cursor-pointer"
            onClick={handleClick}
            onDrop={handleDrop}
            onDragOver={(e) => {
              e.preventDefault();
          ...
          <div className="h-64 w-64 bg-slate-400 pixel-border cursor-pointer group relative">
            <canvas id="pixelCanvas" className="h-full w-full"></canvas>
            {image && (
              <div
                onClick={handleSaveImage}
                className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-60 transition-all duration-200 flex items-center justify-center opacity-0 group-hover:opacity-100"
              >
